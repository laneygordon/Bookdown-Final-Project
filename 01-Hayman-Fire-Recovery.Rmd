...
file_names <-paste0('/Users/laney/OneDrive/Desktop/Enviro Data Sci - 22/Bookdown-Final-Project/data/Hayman fire/') 

hayman_ndmi <- read_csv("Bookdown-Final-Project/data/Hayman fire/hayman_ndmi.csv")
View(hayman_ndmi) 
...
hayman_ndsi <- read_csv("Bookdown-Final-Project/data/Hayman fire/hayman_ndsi.csv")
View(hayman_ndsi)
ndsi <- hayman_ndsi %>% 
  rename(burned=2,unburned=3) %>%
  mutate(data='ndsi')

hayman_ndvi <- read_csv("Bookdown-Final-Project/data/Hayman fire/hayman_ndvi.csv")
View(hayman_ndvi)
ndvi <- hayman_ndvi %>% 
  rename(burned=2,unburned=3) %>%
  mutate(data='ndvi') 
