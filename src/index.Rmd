...
Based on the distribution of the plot, and the calculated correlation value, it appears that there is a strong correlation between ndvi and ndmi, however the graph coloring displays that other factors such as burned vs unburned, also effect the outcome of the data.
...
```
The correlation coefficient for this data is 0.18, which is close to 0, telling us there is a small correlation between monthly average vegetation index for June through August and monthly average snow index from January to April. 
